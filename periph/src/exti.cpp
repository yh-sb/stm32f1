    ...
    _cb(NULL)
{
    ...
    uint8_t exti_offset = (pin % AFIO_EXTICR1_EXTI1_Pos) *
        AFIO_EXTICR1_EXTI1_Pos;
    AFIO->EXTICR[pin / AFIO_EXTICR1_EXTI1_Pos] &= ~(AFIO_EXTICR1_EXTI0 <<
        exti_offset);
    AFIO->EXTICR[pin / AFIO_EXTICR1_EXTI1_Pos] |= _gpio.port() <<
        exti_offset;
